...
from app.repositories.documents.base import DocumentRepository
...
async def get_rag_service(
    ...
    return RAGService(repo=repo, openai_api_key=settings.openai_api_key)
...
async def get_chat_service(
    ...
    context_manager = ContextManager(settings=settings, repo=repo, rag_service=rag_service)
    return ChatService(
        db_session=db,
        repo=repo,
